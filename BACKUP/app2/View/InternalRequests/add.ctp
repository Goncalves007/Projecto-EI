            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <?php echo $this->Form->create('InternalRequest', array('enctype'=>'multipart/form-data')); ?>
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <?php  
                          echo $this->Form->input('beneficiary_id',array('empty' => '---------------------------------------------','class' => 'form-control','label'=>'Beneficiary <span class="symbol required"></span>'),array('escape'=>false));
                         ?>
                        </div>
                        </div>
                        <!-- <div class="col-md-1">
                        <div class="form-group">
                        <?php //echo $this->Html->link('+', array('controller' =>'beneficiaries', 'action'=> 'add','ext',$idUsr,$department_id),array('class' => 'label label-sm label-warning')) ?>
                        </div> 
                       </div>-->
                        <div class="form-group">
                        <?php  
                          echo $this->Form->input('name',array('empty' => '---------------------------------------------','class' => 'form-control','label'=>false,'placeholder'=> ' Informe o nome do beneficiario interno'));
                         ?>
                       </div>
                      </div>
                      <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <?php  
                          ...
                          echo $this->Form->hidden('correios', array('hiddenField' => true, 'value'=> $correio));         
                         ?>
                       </div>
                        <div class="row">
                            <div class="col-md-8">
