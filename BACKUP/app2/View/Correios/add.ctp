            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <?php echo $this->Form->create('Correio'); ?>
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <?php  
                          echo $this->Form->input('name',array('class' => 'form-control','label'=>'Nome do Correio <span class="symbol required"></span>'),array('escape'=>false));
                         ?>
                        </div>
                      </div>
                    </div>
