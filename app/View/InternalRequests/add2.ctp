 ...
 <?php echo $this->element('content_header'); ?> 
                              ...
                              <?php echo ''?>
                                <?php echo $this->Form->create('InternalRequest', array('enctype'=>'multipart/form-data')); ?>
                                  ...
                                  <legend><?php echo __('Add Internal Request'); ?></legend>
                                <div class="col-lg-6">
                                <div class="col-lg-6">
                                <?php 
                                  ...
                                  echo $this->Form->input('amount_in_words', array('type' => 'textarea', 'class' => 'form-control', 'rows' => '3'));
                                  ?>
                                </div>
                                <div class="col-lg-6">
                                  <?php
                                  echo $this->Form->input('provider_id',array('empty' => '---------------------------------------------','class' => 'form-control'));
                                  echo $this->Form->input('beneficiary_id',array('empty' => '---------------------------------------------','class' => 'form-control'));
                             ...
                             <div class="col-lg-6">
                             <?php echo $this->Form->end('attach invoice', array('class' => 'pure-button pure-button-primary')); ?>
                             </div>
                            </div>
