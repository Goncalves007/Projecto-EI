...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Office'), array('action' => 'delete', $office['Office']['id']), array(), __('Are you sure you want to delete # %s?', $office['Office']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($office['ExternalRequest'])): ?>
	...
	<?php foreach ($office['ExternalRequest'] as $externalRequest): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($office['InternalRequest'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Reference Application'); ?></th>
	...
	<?php foreach ($office['InternalRequest'] as $internalRequest): ?>
		<tr>
