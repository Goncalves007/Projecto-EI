<?php echo $this->Form->create('User', array('class' => 'form-horizontal', 'role' => 'form')); ?>
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo __d('admin', 'Administration'); ?></label>
        <div class="col-sm-10">
          <?php 
            echo $this->Form->input('administration_id', array(
              'empty' => '------------',
              'div' => false,
              'label' => false,
              'class' => 'form-control',
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo __d('admin', 'Office'); ?></label>
        <div class="col-sm-10">
          <?php 
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo __d('admin', 'Department'); ?></label>
        <div class="col-sm-10">
          <?php 
      ...
      <div class="form-group <?php echo $this->Form->isFieldError('password') ? 'has-error' : '' ?>">
       ...
       <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label"><?php echo __d('admin', 'boss'); ?></label>
        <div class="col-sm-10">
          <?php 
            echo $this->Form->input('boss', array(
              'div' => false,
