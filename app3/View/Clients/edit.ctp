                ...
                <div class="panel-body">
                  ...
                  <?php echo $this->Form->create('Client'); ?>
                   ...
                   <div class="form-group">
                      ...
                      <div class="form-group">
                        <?php  
                          echo $this->Form->input('budget',array('empty' => '---------------------------------------------','class' => 'form-control','label'=>'Orcamento','readonly'=> 'readonly'));
                          ?>
                       </div>
                       </div>
                       <div class="col-md-6">
                         <div class="form-group">
                        <?php  
                          echo $this->Form->input('used_budget',array('empty' => '---------------------------------------------','class' => 'form-control','label'=>'Valor usado','readonly'=> 'readonly'));
                          ?>
                       </div>
                       </div>
