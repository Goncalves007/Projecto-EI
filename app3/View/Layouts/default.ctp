					...
					<ul class="main-navigation-menu">
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-screen"></i>
								<span class="title"> <?php if($group_id == 10){echo "EXPEDIENTES";}elseif($group_id == 11 || $group_id == 12){echo "CONTRATOS";}elseif($group_id == 1){echo "CONTROL PANEL";}else{echo "REQUESTS";}?> </span><i class="icon-arrow"></i>
							...
							<?php }elseif ($group_id == 12) { ?>
								<li>
								     <?php echo $this->Html->link(__d('admin', '<span class="title">REGISTO DE CONTRATOS</span>'), array('controller' => 'alertContrats', 'action' => 'add'),array('escape'=>false)); ?>
						...
						<li>
							<a href="javascript:;">
								...
								<span class="title"><?php if($group_id == 10){echo "FAZER ACOMPANHAMENTO";}elseif($group_id == 11 || $group_id == 12){echo "PESQUIZAR CONTRATOS";}elseif($group_id == 1){echo "UPDATE FIELD";}else{echo "FOLLOW REQUESTS";}?></span><i class="icon-arrow"></i>
								<span class="arrow "></span>
							</a>
							<ul class="sub-menu">
							<?php if($group_id == 2){  ?>
								         <li>
											<?php echo $this->Html->link(__d('admin', '<span class="title">REQUISICAO EM ANDAMENTO</span>'), array('controller' => 'reports', 'action' => 'progress', $idUsr, $department_id),array('escape'=>false)); ?>
							                </li>
							                <li>
											<?php echo $this->Html->link(__d('admin', '<span class="title">REQUISCAO TERMINADA</span>'), array('controller' => 'reports', 'action' => 'finished', $idUsr, $department_id),array('escape'=>false)); ?>
							                </li>
							                <li>
											<?php echo $this->Html->link(__d('admin', '<span class="title">REQUISICAO REJEITADA</span>'), array('controller' => 'reports', 'action' => 'rejected', $idUsr, $department_id),array('escape'=>false)); ?>
							                </li> 
											<li>
											<?php echo $this->Html->link(__d('admin', '<span class="title">TODAS REQUISICOES</span>'), array('controller' => 'reports', 'action' => 'index', $idUsr, $department_id),array('escape'=>false)); ?>
											</li>
					...
					<ul class="nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu todo">
									...
									<div class="drop-down-wrapper">
										<ul>
										   <li>
											...
											<li>
											<?php echo $this->Html->link(__d('admin', '<span class="badge badge-new">EXTERNAL REQUEST</span>'), array('controller' => 'External_requests', 'action' => 'add',$idUsr),array('escape'=>false)); ?>
											</li>
										   <li>
								...
								<?php }elseif ($group_id==1 || $group_id==6) { ?>
								<li>
									<div class="drop-down-wrapper">
										<ul>
										   <li>
								...
								<?php }elseif ($group_id==1 || $group_id == 7 || $group_id == 8 || $group_id == 9) { ?>
								<li>
									<div class="drop-down-wrapper">
										<ul>
										   <li>
										   ...
										   <?php if ($group_id==1 || $group_id == 8 || $group_id == 9) {?>
										   <li>
						...
						<?php if(!empty($alert)){  ?>
							...
							<ul class="dropdown-menu notifications">
										...
										<ul>
											<li>
												<a href="javascript:void(0)">
													...
													<span class="message"> <?php echo($Report['reference_application']) ?></span>
													<span class="time"><?php echo($Report['created']) ?></span>
												</a>
											</li>
										</ul>
								    <?php } ?>
								...
								<li class="view-all">
								<?php echo $this->Html->link('See all notifications<i class="fa fa-arrow-circle-o-right"></i>',array('controller' => 'reports', 'action' => 'process_d',$department_id),array('escape'=>false)); ?>
								</li>
							</ul>
						</li>
						...
						<li class="dropdown current-user">
							<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
								<span class="username"><?php echo $username.' '.$group_id; ?></span>
