						                  ...
						                  <tbody>
						                   <?php foreach ($Contratados as $Contratado) {?>
						                    <tr>
						                      ...
						                      <?php }?>
						                      <td>
                                                 	<?php echo $this->Html->link('Editar', array('action' => 'edit', $Contratado['AlertContrat']['id'])) ?>
                                                 	<?php
                                                 	if ($Contratado['AlertContrat']['contract_type_id'] == 2) {
                                                 	 echo "| ".$this->Html->link('Prorrogar', array('action' => 'prorogar', $Contratado['AlertContrat']['id']));
                                                     }
                                                      ?>
                                                 	|
                                                    <?php echo $this->Html->link('Apagar', array('action' => 'delete', $Contratado['AlertContrat']['id'])) ?>
                                                 </td>
						                    </tr>
						                    <?php }?>
						                  </tbody>
