...
<h2><?php echo __('Department'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($department['Administration']['label'], array('controller' => 'administrations', 'action' => 'view', $department['Administration']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php if (!empty($department['Beneficiary'])): ?>
	...
	<?php foreach ($department['Beneficiary'] as $beneficiary): ?>
		<tr>
			<td><?php echo $beneficiary['id']; ?></td>
			<td><?php echo $beneficiary['name']; ?></td>
			<td><?php echo $beneficiary['department_id']; ?></td>
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'beneficiaries', 'action' => 'delete', $beneficiary['id']), array(), __('Are you sure you want to delete # %s?', $beneficiary['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
...
<div class="related">
	...
	<?php if (!empty($department['ExternalRequest'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<?php foreach ($department['ExternalRequest'] as $externalRequest): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($department['InternalRequest'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Reference Application'); ?></th>
	...
	<?php foreach ($department['InternalRequest'] as $internalRequest): ?>
		<tr>
