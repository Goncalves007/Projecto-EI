...
<h2><?php echo __('Currency'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($currency['Currency']['label']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php if (!empty($currency['ExternalRequest'])): ?>
	...
	<?php foreach ($currency['ExternalRequest'] as $externalRequest): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($currency['InternalRequest'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Reference Application'); ?></th>
	...
	<?php foreach ($currency['InternalRequest'] as $internalRequest): ?>
		<tr>
